export const pt = {
  ...
  footer: {
    ...
    links: {
      ...
      resources: [
        ...
        { name: "Cobertura de Dados", href: "https://juspilot.ai/cobertura" },
      ...
      company: [
        ...
        { name: "Segurança", href: "https://juspilot.ai/security" },
  ...
  modal: {
    title: "Testar 7 dias grátis",
    subtitle: "Preencha o formulário e nossa equipe libera seu acesso em até 1 dia útil.",
    close: "Fechar",
    success: {
