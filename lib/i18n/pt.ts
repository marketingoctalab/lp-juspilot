export const pt = {
  ...
  metrics: {
    headline1: "Operações jurídicas que",
    headline2: "não param",
    sub: "Resultados de departamentos jurídicos que escolheram operar sem concessões.",
    items: [
      { label: "REDUÇÃO DE TEMPO OPERACIONAL", value: "60%", desc: "em contratos e due diligence" },
      { label: "DOCUMENTOS PROCESSADOS", value: "1M+", desc: "por departamentos ativos" },
      { label: "CONFORMIDADE LGPD", value: "100%", desc: "auditoria e rastreabilidade" },
      { label: "UPTIME GARANTIDO", value: "99.9%", desc: "SLA enterprise com suporte dedicado" },
    ],
  },
  differential: {
    tag: "POR QUE JUSPILOT",
    headline: "Construída para quem não aceita\nsoluções genéricas.",
    sub: "Grandes operações jurídicas exigem infraestrutura à sua altura. Juspilot foi projetada para departamentos que operam sob pressão, volume e escrutínio constante.",
    items: [
      {
  ...
  platform: {
    ...
    headline2: "Toda a operação.",
    sub: "Departamentos jurídicos de alto volume não podem depender de ferramentas fragmentadas. Juspilot unifica contratos, contencioso, compliance e inteligência jurídica em uma infraestrutura única.",
    features: [
      {
  ...
  faq: {
    ...
    headline1: "O que grandes operações",
    headline2: "precisam saber",
    sub: "Respostas diretas para as perguntas que os General Counsels e CIOs fazem antes de decidir.",
    items: [
      {
  ...
  cta: {
    badge: "Para operações que não aceitam meio-termo",
    headline: "Sua operação jurídica merece infraestrutura à sua altura.",
    sub: "Agende uma conversa com nosso time. Vamos entender sua operação e mostrar como Juspilot se encaixa. Sem pitch genérico, sem demo enlatada.",
    primary: "Agendar conversa com especialista",
    secondary: "Ver casos de uso de grandes departamentos",
  },
  footer: {
    tagline: "O cockpit jurídico com IA. Casos, contratos, minutas e jurisprudência em uma única plataforma.",
    available: "Disponível no Brasil",
    columns: {
      product: "Produto",
      resources: "Recursos",
      company: "Empresa",
    ...
    legal: [
      { label: "Termos", href: "https://juspilot.ai/termos-de-uso" },
      { label: "Privacidade", href: "https://juspilot.ai/politica-de-privacidade" },
      { label: "Contato", href: "https://juspilot.ai/contato" },
    ],
